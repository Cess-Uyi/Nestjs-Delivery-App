...
export class RiderRegistration1648799716308 implements MigrationInterface {
    name = 'RiderRegistration1648799716308'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Rider" ("id" SERIAL NOT NULL, "zebrraId" character varying NOT NULL, "avatar" character varying NOT NULL, "dateOfBirth" TIMESTAMP NOT NULL, "stateOfOrigin" character varying NOT NULL, "stateOfResidence" character varying NOT NULL, "residentialAddress" character varying NOT NULL, "phone" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "userZebrraId" character varying, CONSTRAINT "UQ_f41e9fd95aa7688ab57115bba5f" UNIQUE ("phone"), CONSTRAINT "REL_eaeda0aaf72d20330ccec420c8" UNIQUE ("userZebrraId"), CONSTRAINT "PK_cfe2f07d8de1616045e151f0183" PRIMARY KEY ("id"))`);
